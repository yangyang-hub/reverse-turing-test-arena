...
export const ARENA_ABI = [
  ...
  "function getPlayerInfo(uint256 roomId, address player) view returns (tuple(address addr, int256 humanityScore, bool isAlive, uint256 joinBlock, uint256 eliminationBlock, uint256 eliminationRank, uint256 lastActionBlock, uint256 actionCount, uint256 successfulVotes))",
